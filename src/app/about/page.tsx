      ...
      <div className="max-w-5xl mx-auto px-6 py-20">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {[
            ...
            <div key={item.title} className="rounded-2xl border border-white/[0.06] bg-[#0B1422]/60 p-8">
              <div className="text-[#0091D5] mb-4">{item.icon}</div>
        ...
        <div className="text-center">
          ...
          <div className="flex gap-4 justify-center">
            <Link href="/auth/register" className="rounded-xl bg-[#0091D5] px-8 py-3 text-sm font-bold text-black hover:bg-[#007AB8] transition-all">Get Started</Link>
